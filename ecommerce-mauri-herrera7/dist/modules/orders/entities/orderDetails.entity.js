...
let OrderDetails = class OrderDetails {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, price: { required: true, type: () => Number }, order: { required: true, type: () => require("./order.entity").Orders }, products: { required: true, type: () => [require("../../products/entities/products.entity").Products] } };
    }
};
